...
class Calculator(ctk.CTk):
    def __init__(self):
        ...
        self.Display_Font=ctk.CTkFont(family='Arial', size=-24, weight='normal', slant='italic')# Display Only
        temp_dict=json.load(open("Config.json", "r+"))
        global Language
        Language = ""
        if len(temp_dict)==1 or temp_dict["0"] == "" :# Only Theme Exist Or No Language
    ...
    def handle_resize(self):
        try:    
            ...
            for f in range(len(self.base_font_sizes)):
                font_size = int(self.base_font_sizes[f] * scale)
    ...
    def choose_font(self): # Calculator Display Font
        try:
            ...
            size_now=abs(self.Display_Font.cget("size"))
    ...
    def write_setup(self):
        ...
        temp_dict[9]=str(self.Theme.get())
        temp_dict[10]=Default_DPI
        ...
        try:
            ...
            for key, value in data.items():
                ...
                if key=="0":Language = value
                    ...
                    self.Display_Text.focus_force()
                    self.Display_Text.configure(font=self.Display_Font)
                elif key=="9":self.Theme.set(value)
                elif key=="10":
                    global Default_DPI 
                    Default_DPI = value
        except Exception as e:
    ...
    def set_defaults(self):
        temp_dict=json.load(open("Config.json", "r+"))
        if len(temp_dict)==2:# Only Theme Exist
            mp.dps=50
            self.Round.set(15)
