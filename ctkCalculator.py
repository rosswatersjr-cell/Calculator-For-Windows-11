    ...
    def __init__(self, parent, font_dict={}, text="Sample Text For Selected Font", **kwargs):
        ...
        if os.path.exists(fontfile):# Windows Font Family Names are stored in json file. Not reliant on tk families.
            ...
            try:
                ...
                self.font_options = ctk.CTkEntry(self, placeholder_text="Font Options", font=self.chooser_font,  
                                            width=req_width[2], corner_radius=10, state="normal")
                self.font_options.insert(0, "Font Options")
...
class MyDialog(ctk.CTkToplevel):
    def __init__(self, parent, style: Literal["msgbox", "entry"], title, prompt, choices=None, 
        ...
        self.x = int(((self.screen_width / 2) - ((self.width * self.scale_factor) / 2)))
        self.y = int(((self.screen_height / 2) - ((required_height * self.scale_factor) / 2))) - self.min_window
