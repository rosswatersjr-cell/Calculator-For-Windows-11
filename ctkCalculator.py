    ...
    def calculate_ratio(self,a_1,a_2,b_1,b_2,a_3,b_3):
        try:
            ...
            if count < 3:
                ...
                msg=msg1+msg2+msg3
                info_dialog=MyDialog(parent=app, style="msgbox", title=title, prompt=msg, icon="info.png")
            ...
            msg2=repr(e)
            msg=msg1+msg2
            cancel_dialog=MyDialog(parent=app, style="msgbox", title=title, prompt=msg, icon="cancel.png")    
...
class Calculator(ctk.CTk):
    ...
    def about(self):
        ...
        info_dialog=MyDialog(parent=self, style="msgbox", title=title, prompt=msg, icon="info.png")
        self.grab_release()
