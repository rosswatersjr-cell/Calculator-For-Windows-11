...
class Calculator(ctk.CTk):
    def __init__(self, *args, **kwargs):
                ...
                if data["11"]!=str(self.screen_width) or data["12"]!=str(self.screen_height) or data["13"]!=str(self.scale_factor):
                    ...
                    if data["0"]=="":
                        while self.Language.get()=="":
                            lang = MyDialog(parent=self, style="entry", title=title, prompt=msg, choices=["English", "Spanish"], icon="setup.png")
        ...
        hgt=0.75
        y=0.15
        self.base_frame=ctk.CTkFrame(self, border_width=2, corner_radius=10) 
