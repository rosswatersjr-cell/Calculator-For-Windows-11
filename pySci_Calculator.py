...
class MyFontChooser(Toplevel):
    def __init__(self, master, font_dict={}, text="Abcd", title="Font Chooser", **kwargs):
        ...
        options_frame = tk.Frame(self, relief='groove', borderwidth=2)
        ...
        b_bold = tk.Checkbutton(options_frame, text=[font_props[0]], font=dialog_font,
        ...
        b_italic = tk.Checkbutton(options_frame, text=[font_props[1]], font=dialog_font,
        ...
        b_underline = tk.Checkbutton(options_frame, text=[font_props[2]], font=dialog_font,
        ...
        b_overstrike = tk.Checkbutton(options_frame, text=[font_props[3]], font=dialog_font,
                                   variable=self.var_overstrike,
                                   command=self.toggle_overstrike)
        b_overstrike.grid(row=3, sticky="w", padx=4, pady=(2, 4))
        # Size and family
        self.var_size = StringVar(self)
        self.entry_family = tk.Entry(self, width=max_length, validate="key", font=dialog_font,
                                  validatecommand=(self._validate_family, "%d", "%S",
                                                   "%i", "%s", "%V"))
        self.entry_size = tk.Entry(self, width=4, validate="key", font=dialog_font,
                                textvariable=self.var_size,
                                validatecommand=(self._validate_size, "%d", "%P", "%V"))
        self.list_family = tk.Listbox(self, selectmode="browse", font=dialog_font,
                                   listvariable=self.font_family,
                                   highlightthickness=0,
                                   exportselection=False,
                                   width=max_length)
        self.list_size = tk.Listbox(self, selectmode="browse", font=dialog_font,
        ...
        tk.Button(button_frame, text="Ok", font=dialog_font,
               command=self.ok).grid(row=0, column=0, padx=4, sticky='ew')
        tk.Button(button_frame, text=["Cancel"], font=dialog_font,
...
class Ratio_Calculator(tk.Toplevel):
    def __init__(self, parent):
        ...
        global formula_text 
        formula_text=ScrolledText(self, bg='#0c012e', fg='#07f7d8', font=formula_font, 
        ...
        frame1_lbl=tk.Label(frame1, background='#E5E5E5', font=copy_font,
                text=txt[4])
        frame1_lbl.place(relx=0.015, rely=0.02, relwidth=0.97, relheight=0.17)    
        a1_lbl=tk.Label(frame1, background='#E5E5E5', font=copy_font, text='A1')
        a1_lbl.place(relx=0.028, rely=0.23, relwidth=0.07, relheight=0.17)
        self.a1_txtbx=tk.Entry(frame1, background='#FFFFF0', font=copy_font, textvariable=self.a1)
        ...
        a2_lbl=tk.Label(frame1, background='#E5E5E5', font=copy_font, text='A2')
        a2_lbl.place(relx=0.53, rely=0.23, relwidth=0.07, relheight=0.17)
        self.a2_txtbx=tk.Entry(frame1, background='#FFFFF0', font=copy_font, textvariable=self.a2)
        ...
        ratio_lbl=tk.Label(frame1, background='#E5E5E5', font=temp_font,
                text='_______________________     :    _______________________')
        ratio_lbl.place(relx=0.08, rely=0.42, relwidth=0.9, relheight=0.17)
        b1_lbl=tk.Label(frame1, background='#E5E5E5', font=copy_font, text='B1')
        b1_lbl.place(relx=0.028, rely=0.74, relwidth=0.07, relheight=0.17)
        self.b1_txtbx=tk.Entry(frame1, background='#FFFFF0', font=copy_font, textvariable=self.b1)
        ...
        b2_lbl=tk.Label(frame1, background='#E5E5E5', font=copy_font, text='B2')
        b2_lbl.place(relx=0.53, rely=0.74, relwidth=0.07, relheight=0.17)
        self.b2_txtbx=tk.Entry(frame1, background='#FFFFF0', font=copy_font, textvariable=self.b2)
        ...
        for i, item in enumerate(keys): # Prevent Unwanted Keyboard Keys From Appearing In Display
            key_btn.append([num])
            key_btn[i]=tk.Button(kb_frame, text=item,bg="black", fg="white",font=copy_font)
        ...
        frame2_lbl=tk.Label(frame2, background='#E5E5E5', font=copy_font,
                text=txt[5])
        frame2_lbl.place(relx=0.015, rely=0.02, relwidth=0.97, relheight=0.17)    
        a_lbl=tk.Label(frame2, background='#E5E5E5', font=copy_font, text='A')
        a_lbl.place(relx=0.028, rely=0.23, relwidth=0.07, relheight=0.17)
        self.a3_txtbx=tk.Entry(frame2, background='#FFFFF0', font=copy_font, textvariable=self.a3)
        ...
        bAnswer_lbl=tk.Label(frame2, background='#E5E5E5', font=copy_font, text='B =')
        bAnswer_lbl.place(relx=0.53, rely=0.23, relwidth=0.07, relheight=0.17)
        bAnswer=tk.Label(frame2, background='lightgray', font=copy_font, textvariable=self.b4, justify='right',
                anchor='w', borderwidth=1, relief="sunken") 
        bAnswer.place(relx=0.61, rely=0.23, relwidth=0.34, relheight=0.17)
        porportion_lbl=tk.Label(frame2, background='#E5E5E5', font=temp_font,
                text='_______________________    ::    _______________________')
        porportion_lbl.place(relx=0.08, rely=0.42, relwidth=0.9, relheight=0.17)
        b_lbl=tk.Label(frame2, background='#E5E5E5', font=copy_font, text='B')
        b_lbl.place(relx=0.028, rely=0.74, relwidth=0.07, relheight=0.17)
        self.b3_txtbx=tk.Entry(frame2, background='#FFFFF0', font=copy_font, textvariable=self.b3)
        ...
        aAnswer_lbl=tk.Label(frame2, background='#E5E5E5', font=copy_font, text='A =')
        aAnswer_lbl.place(relx=0.53, rely=0.74, relwidth=0.07, relheight=0.17)
        aAnswer=tk.Label(frame2, background='lightgray', font=copy_font, textvariable=self.a4, justify='right',
                anchor='w', borderwidth=1, relief="sunken") 
        aAnswer.place(relx=0.61, rely=0.74, relwidth=0.34, relheight=0.17)
        clr_btn=tk.Button(self, font=copy_font, text=txt[6], fg="black", command=lambda:self.clear_entries())
        clr_btn.place(relx=0.197, rely=0.912, relwidth=0.16, relheight=0.06)
        calc_btn=tk.Button(self, font=copy_font, text=txt[7], fg="red",
        ...
        quit_btn=tk.Button(self, font=copy_font, text=txt[8], fg="black", command=self.ratio_destroy)
...
class Calculus(tk.Toplevel):
    def __init__(self, parent, funct):
        ...
        txt1=self.expr_txt
        r=1    
        self.lbl_1=tk.Label(tk.Frame.scroll.window, background='#f3f6f4', 
                text=txt1, anchor='w')
        ...
        for i in range(len(Symbol_Names)):# Place Names And Values into Dictionary And Populate Labels
            ...
            if Symbol_Names[i] not in self.used_symbols:# Prevent Duplicate Symbol Population
                if str(Symbol_Names[i])!= "rad_to_deg" and str(Symbol_Names[i])!= "rad_to_grad":
                    ...
                    r+=1        
                    self.lbl_2.append([c])
                    self.lbl_2[c]=tk.Label(tk.Frame.scroll.window, background='#f3f6f4', 
        ...
        self.lbl_3=tk.Label(tk.Frame.scroll.window, background='#f3f6f4',
            text=txt[0], anchor='w')
        self.lbl_3.grid(column=0, row=r, sticky=tk.W, padx=5, pady=1)
        r+=1
        self.cbo_lbl=tk.Label(tk.Frame.scroll.window, background='#f3f6f4',
        ...
        self.symbol_bx=ttk.Combobox(tk.Frame.scroll.window, values=self.used_symbols, width=20, font=dialog_font, 
        ...
        if self.funct=='differentiate':
            ...
            self.multi_lbl=tk.Label(tk.Frame.scroll.window, background='#f3f6f4',
                text=txt, anchor='c',width=20)
            self.multi_lbl.grid(column=0, row=r, sticky=tk.W, padx=5, pady=0)
            self.multiple=StringVar()
            r+=1
            style.configure("TCombobox", fieldbackground= '#f0ffff', background= '#f3f6f4')
            self.multi_bx=ttk.Combobox(tk.Frame.scroll.window, values=multiples, width=20, font=dialog_font, 
        ...
        for i in range(0,6):
            r+=1
            self.lbl_4.append([i])
            self.lbl_4[i]=tk.Label(tk.Frame.scroll.window, background='#f3f6f4',
                text='',anchor='w')
...
def precision(which): # Calculator Precision Configuration
    if Language.get()=="English":
        ...
        messages=["Enter Number Of Digits For Calculations. Max = 500","Round Answer To nth Decimal Places. 0 = No Rounding, Max = 500",
                    ...
                    "Choices Are:\n"
                    "8 bits (Byte), 16 bits (Word), 32 bits (Dword), 64 bits (Qword),\n"
                    "128 bits (Double Qword), 256 bits (Yword), 512 (ZWord)"]
    else:
        ...
        messages=["Ingrese el número de dígitos para los cálculos. Máx = 500", "Redondear la respuesta a n lugares decimales. 0 = Sin redondeo, Máx = 500",
                    ...
                    "Opciones Son:\n"
                    "8 bits (Byte), 16 bits (Palabra), 32 bits (Dpalabra), 64 bits (Qpalabra),\n "
                    "128 bits (Doble Qpalabra), 256 bits (Ypalabra), 512 bits (Zpalabra)"]
    if which=='dp':
...
class My_StringDialog(tk.simpledialog._QueryString):
    def body(self, master):# initialvalue May Be List, String Or None
        ...
        pt=tk.Label(master, text=self.prompt, justify="left", font=dialog_font)
        ...
        if self.initialvalue is not None:
            ...
            if type(self.initialvalue)==list:# List
                for item in self.initialvalue:
                    w=len(item)
                    if w>wid:wid=w
                self.entry=ttk.Combobox(master, name="entry", state = "readonly",justify="center",width=wid,font=dialog_font)
                self.entry['values']=self.initialvalue
                self.entry.current(0)
            else:# String
                self.entry=tk.Entry(master, name="entry", justify='center', bg="#d6ffff",width=wid, font=dialog_font)
                self.entry.insert(0, self.initialvalue)
                self.entry.select_range(0, 'end')
        else:# None
            self.entry=tk.Entry(master, name="entry", justify='center', bg="#d6ffff", font=dialog_font)
            self.entry.insert(0, "")
            self.entry.select_range(0, 'end')
...
if __name__ == "__main__":
    ...
    font_sizes = calculate_font_sizes([12, 14, 16, 18, 20, 22, 24])# Get Font Sizes Depending On Monitor Resolution
    dialog_font=font.Font(family='Lucida Sans', size=font_sizes[1], weight='normal', slant='italic')
    root.option_add("*Menu.Font", f"Helvetica {font_sizes[1]}")# Menu Dropdowns  
    root.option_add("*TCombobox*Listbox.font", f"Helvetica {font_sizes[1]}")# Combobox Dropdowns
    root.option_add("*Dialog.msg.font", f"Helvetica {font_sizes[1]}")
    root.option_add("*Dialog.button.font", f"Helvetica {font_sizes[1]}")
    root.option_add("*Label.font", f"Helvetica {font_sizes[1]}")
    root.option_add("*Entry.font", f"Helvetica {font_sizes[1]}")
    root.option_add("*Button.font", f"Helvetica {font_sizes[0]}")
    base_font=font.Font(family='lucidas', size=font_sizes[0], weight='bold', slant='roman')# Base Buttons
    formula_font=font.Font(family='lucidas', size=font_sizes[0], weight='normal', slant='roman')# Base Buttons
    trig_font=font.Font(family='lucidas', size=font_sizes[1], weight='bold', slant='roman')# Trig, Log Buttons 
    copy_font=font.Font(family='Lucida Sans', size=font_sizes[1], weight='normal', slant='roman')
    temp_font=font.Font(family='lucidas', size=font_sizes[2], weight='bold', slant='italic')# F-C, C-F
    memory_font=font.Font(family='lucidas', size=font_sizes[3], weight='bold', slant='italic')# Memory,Ratio,mod,exp
    symbols_font=font.Font(family='lucidas', size=font_sizes[3], weight='normal', slant='italic')# Numeric,math symbols,CM
    bracket_font=font.Font(family='lucidas', size=font_sizes[5], weight='normal', slant='roman')# () Only
    operator_font=font.Font(family='lucidas', size=font_sizes[6], weight='normal', slant='roman')# Math Operators,sign
    ...
    if not os.path.exists("Config.json"):
        ...
        root_width = screen_width*0.4
        root_height = screen_height*0.35
    ...
    display_font=font.Font(family='Lucida Sans', size=font_sizes[4], weight='normal', slant='italic')# Display Only
    ...
    for num in range(0,len(text)):
        ...
        base_btn[num]=tk.Button(base_frame, text=text[num], background='navy', foreground = '#ffffff', # Base Buttons
            borderwidth=5, relief="raised", font=base_font)
    ...
    for num in range(0,len(text)):
        ...
        log_btn[num]=tk.Button(pad_fra, text=text[num], background="purple", foreground = 'whitesmoke', # Log Buttons
            borderwidth=5, relief="raised", font=trig_font)
    ...
    for num in range(0,len(text)): # Function Buttons Column 1
        ...
        func_btn[num]=tk.Button(pad_fra, text=text[num], background="whitesmoke", foreground = 'black', 
                justify="center", anchor="center", activebackground='#ffe599', borderwidth=5, relief="raised", font=symbols_font)
